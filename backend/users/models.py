...
from django.contrib.auth.models import User  # auth_user table
...
class Item(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0)  # add price for filters
    ...
    # New fields
    color = models.CharField(max_length=50, blank=True, null=True)      # detected color
    tags = models.ManyToManyField(Tag, blank=True)                     # detected tags
    image_features = models.JSONField(blank=True, null=True)           # store vector for recommendations
