...
const ItemDetail = () => {
  ...
  useEffect(() => {
    const fetchItem = async () => {
      try {
        const res = await axios.get(`https://astonishing-enchantment-production.up.railway.app/api/items/${id}`);
        setItem(res.data);
      } catch (error) {
  ...
  const handleSwapRequest = async () => {
    try {
      ...
      await axios.post('https://astonishing-enchantment-production.up.railway.app/api/swaps', {
