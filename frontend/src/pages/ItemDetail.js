...
const ItemDetail = () => {
  ...
  useEffect(() => {
    const fetchItem = async () => {
      try {
        const res = await axios.get(`https://renewed-laughter-production.up.railway.app/api/items/${id}`);
        setItem(res.data);
      } catch (error) {
  ...
  const handleSwapRequest = async () => {
    try {
      ...
      await axios.post('https://renewed-laughter-production.up.railway.app/api/swaps', {
